...
class PostgresDriver extends AbstractDriver_1.AbstractDriver {
    constructor() {
        ...
        this.GetAllTablesQuery = (schema) => __awaiter(this, void 0, void 0, function* () {
            const response = (yield this.Connection.query(`SELECT table_schema as "TABLE_SCHEMA",table_name as "TABLE_NAME", table_catalog as "DB_NAME" FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_TYPE='BASE TABLE' AND table_schema in (${schema}) `)).rows;
            return response;
        });
    }
